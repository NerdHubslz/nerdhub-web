<x-app-layout>
    ...
    <div class="bg-[#DB2777] py-16 text-white shadow-inner">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl max-w-2xl mx-auto font-sans leading-relaxed">
    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300 border-b-8 border-pink-500 flex flex-col">
                <div class="p-8 flex flex-col items-center text-center flex-grow">
                    <div class="relative mb-6">
                        <img src="{{ asset('images/podpink/jhenefer-2.jpg') }}" alt="Jhenefer Amorim" class="w-44 h-44 rounded-full object-cover object-top border-4 border-pink-100 shadow-md">
                    ...
                    <p class="text-gray-700 dark:text-gray-200 text-base font-sans mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300 border-b-8 border-pink-500 flex flex-col">
                <div class="p-8 flex flex-col items-center text-center flex-grow">
                    <div class="relative mb-6">
                        <img src="{{ asset('images/podpink/alynne.jpg') }}" alt="Alynne Porto" class="w-44 h-44 rounded-full object-cover object-top border-4 border-pink-100 shadow-md">
        ...
        {{-- Lista de Vídeos Dinâmica do YouTube --}}
        <x-youtube.video-list :videos="$videos" />
        ...
        <div class="bg-pink-50 dark:bg-gray-800 rounded-lg shadow-lg p-10 border border-pink-200 dark:border-pink-900 flex flex-col md:flex-row items-center gap-10">
            ...
            <div class="flex-1 text-center md:text-left">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6 font-sans">
